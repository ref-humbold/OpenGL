...
void main()
{
    ...
    {
        fragmentColor = vec4(0.0, vertexHeight/500.0, 0.0, 1.0);
    }
    else if(vertexHeight <= 1000)
    {
        fragmentColor = vec4(vertexHeight/500.0-1.0, 1.0, 0.0, 1.0);
    }
    else if(vertexHeight <= 2000)
    {
        fragmentColor = vec4(1.0, 2.0-vertexHeight/1000.0, 0.0, 1.0);
    }
    else if(vertexHeight <= 3000)
    {
        fragmentColor = vec4(1.4-vertexHeight/5000.0, vertexHeight/2000.0-1.0, vertexHeight/5000.0-0.4, 1.0);
    }
    else if(vertexHeight <= 4000)
    {
        fragmentColor = vec4(0.2+vertexHeight/5000.0, vertexHeight/2000.0-1.0, vertexHeight/1250.0-2.2, 1.0);
    }
    else
    {
